import { pauseTracking, resetTracking, isRef, toRaw, shallowReactive, trigger, isReactive, effect, stop, isProxy, proxyRefs, toRef, reactive, shallowReadonly, track, computed as computed$1, ref, isReadonly } from '@vue/reactivity';
...
function defineEmit(emitOptions) {
    if ((process.env.NODE_ENV !== 'production') && emitOptions) {
